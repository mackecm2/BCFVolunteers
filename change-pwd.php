...
{
   if($bcfvolunteers->ChangePassword())
   {
        $bcfvolunteers->RedirectToURL("changed-pwd.html");
   }
}
...
<form id='changepwd' action='<?php echo $bcfvolunteers->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
<fieldset >
