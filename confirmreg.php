...
if(isset($_GET['code']))
{
   if($bcfvolunteers->ConfirmUser())
   {
        $bcfvolunteers->RedirectToURL("thank-you-regd.html");
   }
}
...
<form id='confirm' action='<?php echo $bcfvolunteers->GetSelfScript(); ?>' method='get' accept-charset='UTF-8'>
